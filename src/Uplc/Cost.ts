...
export const LargestArg = (slopeId: number, interceptId: number): Function$ => (params: Params) => {
...
export const ArgsSum = (slopeId: number, interceptId: number): Function$ => (params: Params) => {
    const slope = params.get(slopeId)
    const intercept = params.get(interceptId)
...
export const ArgsProd = (slopeId: number, interceptId: number): Function$ => (params: Params) => {
    const slope = params.get(slopeId)
    const intercept = params.get(interceptId)
