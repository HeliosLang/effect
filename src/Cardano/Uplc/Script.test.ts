...
describe("Uplc.Script.eval() for V3s", () => {
  it("can evaluate a UPLCv3 script", () => {
    ...
    const scriptContext = runSync(Data.decode(""))
    const txInfoData = runSync(Data.decode(""))

    const ScriptContextV3 = Data.EnumVariant(0, {
      txInfo: Data.Data,/*Data.EnumVariant(0, {
        inputs: Data.Array(Data.Data),
        refInputs: Data.Array(Data.Data),
        outputs: Data.Array(Data.Data),
        fee: Data.Data,
        minted: Data.Data,
        dcerts: Data.Array(Data.Data),
        withdrawals: Data.PairArray(Data.Data, Data.BigInt),
        validityTimeRange: Data.Data,
        signers: Data.Array(PubKeyHash.FromUplcData),
        redeemers: Data.PairArray(Data.Data, Data.Data),
        datums: Data.PairArray(Data.Data, Data.Data),
        txHash: Data.Data
      }),*/
      redeemer: Data.Data,
      purpose: Data.Data
    ...
    const scriptContextReadable = Schema.decodeUnknownSync(ScriptContextV3)(scriptContext)
    
    console.log(scriptContextReadable.txInfo)
    console.log(scriptContextReadable.redeemer)

    const correctScriptContext = Data.makeConstrData(0, [
      txInfoData,
      scriptContextReadable.redeemer,
      scriptContextReadable.purpose
    ])
