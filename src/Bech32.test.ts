...
describe("Bech32.encode", () => {
    ...
    it('returns "foo1vehk7cnpwgry9h96" for "foobar" with "foo" human-readable-part', () => {
        expect(
            Bech32.encode("foo", Utf8.encode("foobar")),
        ).toBe(
...
describe("Bech32.decode", () => {
    ...
    it('returns #70a9508f015cfbcffc3d88ac4c1c934b5b82d2bb281d464672f6c49539 for "addr_test1wz54prcptnaullpa3zkyc8ynfddc954m9qw5v3nj7mzf2wggs2uld"', () => {
        expect(
            ...
            Either.right({
                prefix: "addr_test",
                bytes: [0x70, 0xa9, 0x50, 0x8f, 0x01, 0x5c, 0xfb, 0xcf, 0xfc, 0x3d, 0x88, 0xac, 0x4c, 0x1c, 0x93, 0x4b, 0x5b, 0x82, 0xd2, 0xbb, 0x28, 0x1d, 0x46, 0x46, 0x72, 0xf6, 0xc4, 0x95, 0x39]
            })
        )
    })
    ...
    it("for script1agrmwv7exgffcdu27cn5xmnuhsh0p0ukuqpkhdgm800xksw7e2w", () => {
        expect(
            ...
            Either.right({
                prefix: "script",
                bytes: [0xea, 0x07, 0xb7, 0x33, 0xd9, 0x32, 0x12, 0x9c, 0x37, 0x8a, 0xf6, 0x27, 0x43, 0x6e, 0x7c, 0xbc, 0x2e, 0xf0, 0xbf, 0x96, 0xe0, 0x03, 0x6b, 0xb5, 0x1b, 0x3b, 0xde, 0x6b]
            })
        )
    })
})
